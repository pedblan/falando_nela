...
- [ ] Reconfirmar a pasta de destino vazia imediatamente antes da primeira escrita.
...
- [ ] Aprovar `operation_id`, lote sentinela, limites e comandos exatos.
- [ ] Copiar sentinela e comparar caminho, tamanho e hash.
- [ ] Retomar sentinela e confirmar zero cópia adicional.
- [ ] Aprovar ampliação em lotes.
- [ ] Reconciliar cada lote antes de avançar.
- [ ] Reconciliar catálogo final por bijeção, tamanho e hash.
- [ ] Confirmar origem intacta e árvore canônica exposta por remote read-only.
...
divergência, e foi reexecutada sem nova tentativa. Transporte e integridade do
raw continuam pendentes até o sentinela.
